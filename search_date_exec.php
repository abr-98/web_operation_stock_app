...
#echo($value);
$sql = "SELECT * from STOCK_DETAILSS where $field='$value' and Date_update='$Date_update'";
$rs = mysqli_query($conn,"select * from STOCK_DETAILSS WHERE $field='$value'and Date_update='$Date_update'");
