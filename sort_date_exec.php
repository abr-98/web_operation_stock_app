...
#echo($field);
$order=$_POST['formsort'];
#echo($order);
$Date_update=$_POST['Date'];
#echo($Date_update);
$sql = "SELECT * from STOCK_DETAILSS WHERE Date_update='$Date_update' ORDER BY $field $order";
$rs = mysqli_query($conn,"SELECT * from STOCK_DETAILSS WHERE Date_update='$Date_update' ORDER BY $field $order");
