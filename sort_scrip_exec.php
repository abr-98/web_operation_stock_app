...
$sql = "SELECT * from STOCK_DETAILSS WHERE Scrip='$Stock' ORDER BY $field $order";
$rs = mysqli_query($conn,"SELECT * from STOCK_DETAILSS WHERE Scrip='$Stock' ORDER BY $field $order");
